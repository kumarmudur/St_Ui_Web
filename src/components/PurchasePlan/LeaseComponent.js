...
class LeaseComponent extends Component {
    constructor(props) {
        ...
        this.disabledBallonPayment = true;
    }
    ...
    _getInitialState = data => {
        const obj = {
            ...
            buyoutYear: data && data.buyoutYear || '',
            residualValue: data && data.residualValue || '',
    ...
    componentWillReceiveProps(nextProps) {
      ...
      if(purchasePlanData && purchasePlanData.proposalType !=='Finance' || purchasePlanData && purchasePlanData.proposalType !=='Purchase') {
        obj = this._getInitialState(purchasePlanData);
        purchasePlanData.balloonPayment1DueMonth ? this.disabledBallonPayment = false : this.disabledBallonPayment = true; 
      } else {
    ...
    _onFieldChange = e => {
        ...
        if(name === 'balloonPayment1') {
          if(value === 'Yes') {
            this.disabledBallonPayment = false;
          } else if(value === 'No') {
            this.disabledBallonPayment = true;
                ...
                <div className="row">
                    ...
                    <span className="wrapper">
                        <FloatingLabel 
                          ...
                          onChange={ this._onFieldChangeNumericInt }
                          readOnly={ this.disabledBallonPayment }
                        />  
