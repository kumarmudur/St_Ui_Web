...
class EditProfileComponent extends Component {
    ...
    render() {
      ...
      const { errorFirstName, errorLastName, errorHouseBuilding, errorStreet, errorZipcode, errorCity, errorCounty, errorCountry, 
        errorState, errorCompanyEin, errorCompanyName, errorRegistrationState } = this.state.errors;
      ...
      let role = this.props && this.props.userData && this.props.userData.role ? this.props.userData.role : '';  
        ...
        return (
            <div className="content edit-profile">
                <div className="row">
                    ...
                    <div className="cols readonly-field-style">
                        <span className="form-label">Role</span> <span className="form-label-text">{ role }</span>
                    </div>
                </div>
